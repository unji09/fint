...
public record PresignedUrlRequest(
        ...
        @NotNull(message = "purpose 는 필수입니다. (MEETING_RECORD | OCR | THUMBNAIL)") FilePurpose purpose,
        ...
        @Positive(message = "dashboardId 는 0보다 커야 합니다.") Long dashboardId
) {}
